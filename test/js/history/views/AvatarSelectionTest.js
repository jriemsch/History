...
TestCase('AvatarSelectionTest', {
  ...
  testCreateNullAndTypeSafe: function () {
    ...
    assertException(function () { AvatarSelection.create(template, template, null); }, 'TypeError');
    assertException(function () { AvatarSelection.create(template, null, template); }, 'TypeError');
    assertException(function () { AvatarSelection.create(null, template, template); }, 'TypeError');

    assertException(function () { AvatarSelection.create(template, template, {}); }, 'TypeError');
    assertException(function () { AvatarSelection.create(template, {}, template); }, 'TypeError');
    assertException(function () { AvatarSelection.create({}, template, template); }, 'TypeError');
  },

  testShowAndHide: function () {
    var sel = AvatarSelection.create(this.imageSelectionTemplate, this.avatarTemplate, this.backgroundTemplate);
  ...
  testAllImagesShown: function () {
    AvatarSelection.create(this.imageSelectionTemplate, this.avatarTemplate, this.backgroundTemplate).show();
